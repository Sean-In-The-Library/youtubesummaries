...
def start_analysis():
    ...
    with st.spinner('Scraping videos... This may take a moment.'):
        ...
        if channel_snapshot_id is None:
            status_container.error("Failed to initiate scraping. Please check your API key and try again.")
            return
